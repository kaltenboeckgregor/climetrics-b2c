    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-[var(--brand-cloud)] text-[var(--brand-graphite)]">
      ...
      <section className="relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(600px 300px at 20% 20%, var(--brand-cyan), transparent), radial-gradient(600px 300px at 80% 0%, var(--brand-emerald), transparent)",
          }}
        />
        <div className="mx-auto max-w-6xl px-4 py-20 grid md:grid-cols-2 gap-10 items-center">
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <a href="#features" className="btn btn-quiet">
                Mehr erfahren
              </a>
            </div>
          </div>
